var NewProjectForm = React.createClass({
    ...
    getInitialState: function () {
        return {name: "", description: "", project_cost: "", project_net_cost: '', formErrors: {}};
    },

    resetState: function () {
        this.setState({name: "", description: "", project_cost: "", project_net_cost: '', formErrors: {}});
    },
        ...
        this.props.parentProjectSubmit(
            {
                project: {
                    ...
                    project_net_cost: this.state.project_net_cost
                }
            },
            this.resetState,
    ...
    handleProjectNetCostChange: function (e) {
        this.setState({project_net_cost: e.target.value});
    },
    ...
    renderProjectNetCostField: function () {

        var formGroupClass = this.state.formErrors["project_net_cost"] ? "form-group has-error" : "form-group"
            ...
            <div className='row'>
                ...
                <div className='col-sm-4'>
                    ...
                    <div className={formGroupClass}>
                        ...
                        <input
                            name="project[project_net_cost]"
                            type="number"
                            placeholder="Project NetCost"
                            value={this.state.project_net_cost}
                            onChange={this.handleProjectNetCostChange}
                            className="numeric decimal form-control"
                        />

                        {this.renderFieldErrors("project_net_cost")}
        ...
        return (
            <div>
                ...
                <form style={{marginTop: "30px"}} onSubmit={this.newProjectSubmit}>
                    ...
                    {this.renderProjectNetCostField()}
